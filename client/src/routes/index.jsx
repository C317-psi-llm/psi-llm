    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={<PsychologistInsightsPage />}
        />
        ...
        <Route
          path="/insights"
          element={<Navigate to="/patient/insights" replace />}
        />
        <Route path="/chat" element={<Navigate to="/patient/chat" replace />} />
        <Route
          path="/questionario"
          element={<Navigate to="/patient/questionario" replace />}
        />
        <Route
          path="/gamificacao"
          element={<Navigate to="/patient/gamificacao" replace />}
        />
